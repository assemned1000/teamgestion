...
export const PersonalExpenses = () => {
  ...
  const [displayCurrency, setDisplayCurrency] = useState(() =>
    localStorage.getItem('personalExpenses_displayCurrency') || 'dzd'
  );
  ...
  useEffect(() => {
    localStorage.setItem('personalExpenses_displayCurrency', displayCurrency);
  }, [displayCurrency]);
          ...
          <div className="overflow-x-auto">
                ...
                {filteredExpenses.map((expense, index) => (
                  <tr key={expense.id} style={{ borderBottom: index < filteredExpenses.length - 1 ? '1px solid rgba(255, 255, 255, 0.03)' : 'none' }}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-semibold text-right" style={{ color: '#EAEAF0' }}>
                      {expense.amount.toLocaleString()} {getCurrencyDisplay(expense.currency)}
                    </td>
                      ...
                      <div className="flex justify-end gap-1">
                        <button
                          ...
                          onMouseLeave={(e) => {
                            ...
                            e.currentTarget.style.color = '#9AA0AB';
                          }}
                        >
                          <Edit size={16} />
                        </button>
            ...
            {filteredExpenses.length === 0 && (
              <div className="text-center py-16">
                <p className="text-base" style={{ color: '#6B7280' }}>Aucune dépense personnelle</p>
              </div>
            )}
          </div>
        </div>
